...
# SimpleWeb.Endpoint.init/2 when load_from_system_env is
...
config :simple, SimpleWeb.Endpoint,
  ...
  http: [port: 4000],
  url: [scheme: "https", host: "simple.com", port: 443],
  server: true

config :simple, site_url: "https://www.simple.com"

# CORS allowed origins
config :simple, allowed_origins: [
  "http://simple.com",
  "http://www.simple.com",
  "https://simple.com",
